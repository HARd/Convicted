...
public class ActionPanel : ActionPanelController 
{
	...
	void Awake () 
	{
		...
		CharacterImage.sprite = SpriteManager.Instatce.GetSprite("Pers/pers_" + PlayerInfo.Instance.charImageID);//GUIController.Instance.CharImageList[PlayerInfo.Instance.charImageID];
//		CharacterImageText.text = PlayerInfo.Instance.characterNumber;
		CharacterNameText.text = Localization.Instance.GetLocale(815 + PlayerInfo.Instance.charImageID);
	}
