...
public class Action : MonoBehaviour 
{
	...
	public List<string> requireWeapon = new List<string>();
	...
	void Start()
	{
		...
		eventPanel = PanelManager.Instance.EventPanel.gameObject;
	}
	...
	public bool VerifyActionRequirements(bool no_energy = false)
	{
		...
		return Inventory.Instance.HasTools(requireItem) && Inventory.Instance.HasTools(requireWeapon) && VerifyRequireStat(no_energy) && story_check;
	}
}
